...
namespace Drones
{
    public class DroneManager
    {
        ...
        public void AddDrone(string type)
        {
            ...
            if (newDrone is ICivilianDrone civDrone)
            {
                _CivilianDroneList.Add(civDrone);
            }
            else if (newDrone is IMilitaryDrone milDrone)
            {
                _MilitaryDroneList.Add(milDrone);
            }
        }
